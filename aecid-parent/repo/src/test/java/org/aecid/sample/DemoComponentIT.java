...
public class DemoComponentIT extends AbstractAlfrescoIT {
    ...
    public void testGetCompanyHome() {
        DemoComponent demoComponent = (DemoComponent) getApplicationContext().getBean("org.aecid.DemoComponent");
...
//        assertEquals("Company Home", companyHomeName);
    ...
    @Test
    public void testGetCompanyHome2() {
        DemoComponent demoComponent = (DemoComponent) getApplicationContext().getBean("org.aecid.DemoComponent");
        NodeRef companyHome = demoComponent.getCompanyHome();
        System.out.println("ID companyHome node: " + companyHome.getStoreRef().getIdentifier());
    }
